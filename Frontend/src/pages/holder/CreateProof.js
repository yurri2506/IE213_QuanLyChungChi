      ...
      <Helmet>
        ...
        <div className=" m-10 p-10 rounded-xl shadow-lg space-y-6">
            ...
            <div className="flex gap-2 items-center  justify-between">
                ...
                />
                <button onClick={handleVerify} className="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg text-white font-semibold">Kiểm tra</button>
            </div>
            ...
            {isVerified && (
                ...
                <button onClick={handleGenerateProof} className="bg-blue-600 hover:bg-blue-700  px-4 py-2 rounded-lg text-white font-semibold">Generate Proofs</button>
                </div>
            )}
            </div>
    </NavigationHolder>
